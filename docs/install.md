...
```bash
pipx install https://github.com/devopsinside/burn-o-meter/releases/download/v0.6.3/burn_o_meter-0.6.3.tar.gz
# or
uv tool install https://github.com/devopsinside/burn-o-meter/releases/download/v0.6.3/burn_o_meter-0.6.3.tar.gz
```
