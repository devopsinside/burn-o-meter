...
```bash
pipx install https://github.com/devopsinside/burn-o-meter/releases/download/v0.3.1/burn_o_meter-0.3.1.tar.gz
# or
uv tool install https://github.com/devopsinside/burn-o-meter/releases/download/v0.3.1/burn_o_meter-0.3.1.tar.gz
```
